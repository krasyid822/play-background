    ...
    style.textContent = `
        #ambient-audio-widget {
            ...
            background:
                ...
                linear-gradient(180deg, rgba(52, 29, 16, 0.97), rgba(27, 15, 10, 0.97));
            box-shadow:
                inset 0 0 0 2px #a86a3f,
                inset 0 0 0 5px #140a06,
        ...
        .ambient-audio-toggle {
            border: 2px solid #a86a3f;
            border-radius: 4px;
            padding: 10px 16px;
            background: linear-gradient(180deg, #fcd34d, #f59e0b);
            color: #2b1208;
            font: 400 0.74rem 'Press Start 2P', 'Courier New', monospace;
            letter-spacing: 0.07em;
            text-transform: uppercase;
            cursor: pointer;
            box-shadow: 0 4px 0 #8b4f19;
            margin-top: 0;
            width: auto;
            min-width: 0;
        ...
        .ambient-audio-marquee {
            ...
            border-radius: 4px;
            border: 2px solid #a86a3f;
            background: linear-gradient(180deg, #25140c, #1a0f0a);
            padding: 3px 0;
            box-shadow: inset 0 0 0 2px #140a06;
        }
        ...
        .ambient-audio-track-list {
            border: 2px solid #a86a3f;
            border-radius: 4px;
            background: linear-gradient(180deg, #311c11, #25140c);
            color: #ffe8b7;
            font: 400 1.14rem 'VT323', 'Courier New', monospace;
            padding: 7px 8px;
            min-width: 0;
            box-shadow: inset 0 0 0 2px #140a06;
        }

        .ambient-audio-track-list:focus {
            outline: 0;
            border-color: #f59e0b;
        }
        ...
        .ambient-audio-mini-btn {
            border: 2px solid #a86a3f;
            border-radius: 4px;
            background: linear-gradient(180deg, #533322, #3d2518);
            color: #ffe8b7;
            font: 400 1rem 'VT323', 'Courier New', monospace;
        ...
        .ambient-audio-text {
            flex: 0 0 auto;
            padding-right: 38px;
            font: 400 1.05rem 'VT323', 'Courier New', monospace;
            letter-spacing: 0.08em;
            text-transform: uppercase;
            color: #fde68a;
            text-shadow: 0 0 6px rgba(249, 115, 22, 0.28);
            white-space: nowrap;
        }
